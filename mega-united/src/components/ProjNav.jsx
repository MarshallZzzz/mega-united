    ...
    overflow-hidden' id='ProjNav'>
      ...
      <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Serving our community</p>
        ...
        <div className='overflow-hidden'>
            ...
            ease-in-out object-cover' style={{transform: `translateX(-${(currentIndex * 105)}%)`}}>
                {projectsData.map((project, index)=>(
                    <div key={index} className='flex-row flex-shrink-0 w-full'>
                        <img src={project.image} alt={project.title} className='w-full h-auto object-cover mb-14'/>
                        <div className='left-0 right-0 bottom-5 flex justify-center'>
